  ...
  def render(assigns) do
    ...
    <div class="max-w-5xl mx-auto px-4 py-8">
      ...
      <div class="mb-10 text-center">
        ...
        <h1 class="text-3xl font-black text-slate-100 tracking-tight mb-1">Neovim Odyssey</h1>
      ...
      <%!-- Zone Map --%>
      <h2 class="text-xl font-bold text-slate-200 mb-4 tracking-wider uppercase">Zone Map</h2>
      <div class="relative">
        <%!-- Connecting path --%>
        <div class="absolute left-1/2 top-0 bottom-0 w-px border-l-2 border-dashed border-slate-700/50 hidden md:block" />
